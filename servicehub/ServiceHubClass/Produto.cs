    ...
    public class Produto
    {
       ...
       public void Inserir()
        ...
        public static Produto ObterPorId(int id)
        {
            ...
            {
                produto = new(
                    dr.GetInt32(0), dr.GetString(1), dr.GetString(2), dr.GetDouble(3), dr.GetString(4), Categoria.ObterPorId(dr.GetInt32(5)), dr.GetDouble(6), dr.GetDouble(7), null, dr.GetDateTime(9), dr.GetBoolean(10));
            }
            return produto;
        }
